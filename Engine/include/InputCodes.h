...
namespace Input {
	...
	inline bool IsReleased(const State state)
	{
		return state == State::Released || state == State::JustReleased;
	}

	inline bool IsJustReleased(const State state)
	{
		return state == State::JustReleased;
	}	

	inline bool IsPressed(const State state)
	{
		return state == State::Pressed || state == State::JustPressed;
	}

	inline bool IsJustPressed(const State state)
	{
