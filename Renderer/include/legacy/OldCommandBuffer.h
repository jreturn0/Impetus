...
//
//		CommandBuffer(const vk::Device& device, const CommandPool& commandPool);
//
//		friend UniqueCommandBuffer CreateUniqueCommandBuffer(const vk::Device& device, const CommandPool& commandPool);
//	public:
...
//	};
//	UniqueCommandBuffer CreateUniqueCommandBuffer(const vk::Device& device, const CommandPool& commandPool);
//}
