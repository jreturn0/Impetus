...
//	const char* title;
//
//	static GLFWwindow* createWindow(const char* title, uint32_t width, uint32_t height)
//	{
...
//public:
//
//	Window(const char* title, uint32_t width, uint32_t height) : glfw(createWindow(title,width,height)), width(width), height(height),title(title){}
//
...
//	glfwInit();
//	
//	auto window = Window("Vulkan 101",width, height );
//
...
//	}
//
//	auto physicalDevice = physicalDevices.front(); /*physicalDevices[std::distance(physicalDevices.begin(),
